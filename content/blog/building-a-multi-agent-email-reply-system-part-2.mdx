...
> This is Part 2. [Part 1 covers the core pipeline](/writing/building-a-multi-agent-email-reply-system): webhook ingestion, intent classification, the writer/reviewer loop, and the production bugs that followed going live.
