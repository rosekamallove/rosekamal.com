...
export function Instagram({ size = defaultSize, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function YouTube({ size = defaultSize, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function XTwitter({ size = defaultSize, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
