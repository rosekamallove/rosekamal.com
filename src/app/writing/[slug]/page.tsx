...
export default async function PostPage({ params }: Props) {
  ...
  return (
    <div className="relative">
      ...
      {/* ── Fixed TOC sidebar — desktop only, managed inside TableOfContentsDesktop ── */}
      <TableOfContentsDesktop entries={toc} title={post.title} slug={post.slug} />
      ...
      <article>
        ...
        <TableOfContentsMobile entries={toc} title={post.title} slug={post.slug} />
